    ...
    <?php endif; ?>
                ...
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item dropdown user-menu">
                        <a href="#" class="nav-link dropdown-toggle" data-bs-toggle="dropdown">
                            <img
                                src="uploads/fotos/paola.jpg"
                                class="user-image rounded-circle shadow"
                                alt="User Image" />
                            <span class="d-none d-md-inline">Paola Tapia</span>
                        </a>
                        <ul class="dropdown-menu dropdown-menu-lg dropdown-menu-end">
                            <!--begin::User Image-->
                            <li class="user-header text-bg-primary">
                                <img
                                    ...
                                    alt="User Image" />
                                <p>
                                    Paola Tapia - Web Developer
                                    <small>Desde Nov. 2024</small>
                                </p>
                            </li>
                            <!--end::User Image-->
                            <!--begin::Menu Body-->
        ...
        <aside class="app-sidebar bg-body-secondary shadow" data-bs-theme="dark">
            ...
            <div class="sidebar-brand">
                ...
                <a href="./index.html" class="brand-link">
                    <!--begin::Brand Image-->
                    <img
                        src="uploads/img/la marqueza.jpg"
                        alt="La Marqueza Restaurant"
                        class="brand-image opacity-75 shadow" />
                    <!--end::Brand Image-->
                    <!--begin::Brand Text-->
                    <span class="brand-text fw-light">La Marqueza</span>
                    <!--end::Brand Text-->
                </a>
                <!--end::Brand Link-->
            </div>
                    ...
                    <ul
                        ...
                        <li class="nav-item menu-open">
                            ...
                            <ul class="nav nav-treeview">
                                <li class="nav-item">
                                    <a href="./?view=Menu" class="nav-link active">
